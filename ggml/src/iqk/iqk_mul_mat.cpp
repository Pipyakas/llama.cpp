...
// port: dropped iqk_quantize.h
// port: dropped iqk_flash_impl.h
// port: dropped iqk_gemm_floats.h
#include "iqk_gemm_kquants.h"
#include "iqk_gemm_ktquants.h"
#include "iqk_gemm_iquants.h"
#include "iqk_gemm_iqk_quants.h"
// port: dropped iqk_gemm_1bit.h
...
struct MulMat {
    ...
    static inline ggml_type is_dequant_better(ggml_type type, int nrc_y) { return type; }
...
#endif
template <int head_dim>
void iqk_fused_delta_net_impl(int n_heads, int gqa_ratio, int repeat_type, int n_tokens, int n_seqs,         size_t vnb1, size_t vnb2, size_t vnb3,         const float * q_data, const float * k_data, const float * v_data, const float * g_data, const float * beta_data,         const float * state_in, float * out_data, float * state_out, float * saved_steps, int state_step_stride, int ith, int nth) {  }
}

bool iqk_fused_delta_net(int head_dim, int n_heads, int gqa_ratio, int repeat_type, int n_tokens, int n_seqs,         size_t vnb1, size_t vnb2, size_t vnb3,         const float * q_data, const float * k_data, const float * v_data, const float * g_data, const float * beta_data,         const float * state_in, float * out_data, float * state_out, float * saved_steps, int state_step_stride, int ith, int nth) { return false; }
...
void iqk_bucket_topk(int nval, int ntop, float * values, int * idx, int * idx_inf, int nbucket, int * counts,         int * idx_aux) {  }
#ifdef __AVX2__
...
bool iqk_indexer_topk(struct ggml_tensor * dst, void * work_buffer, barrier_t barrier, void * barrier_data, int ith, int nth) { return false; }
...
bool iqk_fused_delta_net(int, int, int, int, int, int,         size_t, size_t, size_t,         const float *, const float *, const float *, const float *, const float *,         const float *, float *, float *, float *, int, int, int) { return false; }

bool iqk_indexer_topk(struct ggml_tensor *, void *, barrier_t, void *, int, int) { return false; }
