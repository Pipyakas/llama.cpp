...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q2_0_128] = {
        .type_name                = "q2_0_128",
        .blck_size                = QK2_0_128,
        .type_size                = sizeof(block_q2_0_128),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q2_0_128,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q2_0_128_ref,
    },
    [GGML_TYPE_Q4_0] = {
        .type_name                = "q4_0",
        .blck_size                = QK4_0,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q2_0_128: result = quantize_q2_0_128(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
