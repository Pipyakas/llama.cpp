...
// NVFP4 KV cache: only the symmetric (nvfp4 K, nvfp4 V) case is instantiated
// because the default build only dispatches symmetric quantized pairs.
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_NVFP4, GGML_TYPE_NVFP4);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_NVFP4, GGML_TYPE_NVFP4);
